...
namespace Proxy.Client.Test
{
    ...
    internal sealed class Socks5ProxyClientTests
    {
        ...
        {
            Assert.Throws<TimeoutException>(() => _socks5ProxyClient.Get("http://www.example.com/", readTimeout: 0));
        }

        [Test]
        public void GetAsync_WithTotalTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.GetAsync("http://www.example.com/", totalTimeout: 0));
        }

        [Test]
        public void GetAsync_WithReadTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.GetAsync("http://www.example.com/", readTimeout: 0));
        }

        [Test]
        public void GetAsync_WithWriteTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.GetAsync("http://www.example.com/", writeTimeout: 0));
        }
        ...
        {
            Assert.Throws<TimeoutException>(() => _socks5ProxyClient.Post("http://www.example.com/", "testContent", readTimeout: 0));
        }

        [Test]
        public void PostAsync_WithTotalTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.PostAsync("http://www.example.com/", "testContent", totalTimeout: 0));
        }

        [Test]
        public void PostAsync_WithReadTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.PostAsync("http://www.example.com/", "testContent", readTimeout: 0));
        }

        [Test]
        public void PostAsync_WithWriteTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.PostAsync("http://www.example.com/", "testContent", writeTimeout: 0));
        }
        ...
        {
            Assert.Throws<TimeoutException>(() => _socks5ProxyClient.Put("http://www.example.com/", "testContent", readTimeout: 0));
        }

        [Test]
        public void PutAsync_WithTotalTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.PutAsync("http://www.example.com/", "testContent", totalTimeout: 0));
        }

        [Test]
        public void PutAsync_WithReadTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.PutAsync("http://www.example.com/", "testContent", readTimeout: 0));
        }

        [Test]
        public void PutAsync_WithWriteTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.PutAsync("http://www.example.com/", "testContent", writeTimeout: 0));
        }
        ...
        {
            Assert.Throws<TimeoutException>(() => _socks5ProxyClient.Delete("http://www.example.com/", readTimeout: 0));
        }

        [Test]
        public void DeleteAsync_WithTotalTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.DeleteAsync("http://www.example.com/", totalTimeout: 0));
        }

        [Test]
        public void DeleteAsync_WithReadTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.DeleteAsync("http://www.example.com/", readTimeout: 0));
        }

        [Test]
        public void DeleteAsync_WithWriteTimeout_TimedOut()
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.DeleteAsync("http://www.example.com/", writeTimeout: 0));
        }
