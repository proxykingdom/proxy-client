...
namespace Proxy.Client.Test
{
    ...
    internal sealed class Socks5ProxyClientTests
    {
        ...
        {
            var response = await _socks5ProxyClient.GetAsync("http://www.example.com/", timeout: 10000);
        ...
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.GetAsync("http://www.example.com/", timeout: 0));
        }
        ...
        {
            var response = await _socks5ProxyClient.PostAsync("http://www.example.com/", "testContent", timeout: 10000);
        ...
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.PostAsync("http://www.example.com/", "testContent", timeout: 0));
        }
        ...
        {
            var response = await _socks5ProxyClient.PutAsync("http://www.example.com/", "testContent", timeout: 10000);
        ...
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.PutAsync("http://www.example.com/", "testContent", timeout: 0));
        }
        ...
        {
            var response = await _socks5ProxyClient.DeleteAsync("http://www.example.com/", timeout: 10000);
        ...
        {
            Assert.ThrowsAsync<TimeoutException>(async () => await _socks5ProxyClient.DeleteAsync("http://www.example.com/", timeout: 0));
        }
